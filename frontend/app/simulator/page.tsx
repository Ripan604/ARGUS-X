...
export default function VirtualAcousticBench() {
  ...
  const downloadCsv = () => {
    const rows = ['time_s,amplitude_normalized', ...simulation.samples.map((sample, index) => `${(index / config.sampleRateHz).toFixed(9)},${sample.toFixed(9)}`)];
